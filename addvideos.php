...
<html> 
	<head> 
		<script> 
			function register() { 
				...
				if (topic.value == "") { 
					window.alert("Please enter the topic's name"); 
					topic.focus(); 
					return false; 
				}				

				if (link.value == "") { 
					window.alert("Please enter the video link"); 
					link.focus(); 
					return false; 
				}				
	...
	<body> 
	<div id="formstyle">
		<h1 style="text-align: center;">Fill this form to add new subject Videos</h1> 
		<form id="rform" name="RegForm" action="addvideosprocess.php"
			...
			<p>New video's Link: <input type="text"
							size="65" name="link" /></p> 
			<br /> 
